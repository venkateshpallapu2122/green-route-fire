import { LayoutDashboard, MapPinned, Truck, BarChart3, Settings as SettingsIcon, Leaf, Fuel, CloudCog } from 'lucide-react';
...
export const DASHBOARD_METRICS = [
  ...
  { id: 'fuel_saved', title: 'Est. Fuel Saved', value: '0', icon: Fuel, unit: 'Liters' },
...
export const VEHICLE_TYPES: Vehicle['type'][] = ['Van', 'Truck (Light)', 'Truck (Heavy)', 'Car', 'Motorcycle'];
